 ...
 */
export const SEED_ANCHOR = new Date("2026-08-19T09:00:00");
...
export const seedUsers: User[] = [
  ...
  },
  {
    ...
    specialty: "Urgência / Triagem Pediátrica",
...
const seedConsultationTemplates: SeedConsultation[] = [
  ...
  },
  {
    ...
    scheduledOffset: null,
    symptoms: [],
    otherSymptom: "Manchas vermelhas na barriga desde ontem",
    notes: "Sintoma descrito em texto livre no menu USSD.",
    channel: "VOZ",
    priority: "AVALIACAO",
    status: "PENDENTE",
    source: "USSD",
